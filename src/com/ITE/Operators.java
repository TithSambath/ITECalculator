...
public class Operators {
     ...
     */
        void calledArithmeticOperators(int option){
            ...
            System.out.print("____________________________________\n");
            switch (option){
                case 1 : System.out.println("       Sum Operator");
                    System.out.println("Enter Number for A and B:");
                    System.out.print("A: ");A = scan.nextInt();
                    System.out.print("B: ");B = scan.nextInt();
                    answerAsInt = Sum(A,B);
                    System.out.println("Answer = "+answerAsInt);
                    break;
                case 2 : System.out.println("       Divide Operator");
                    System.out.println("Enter Number for A and B:");
                    System.out.print("A: ");A = scan.nextInt();
                    System.out.print("B: ");B = scan.nextInt();
                    ...
                    break;
                case 3 : System.out.println("       Minus Operator");
                    System.out.println("Enter Number for A and B:");
                    System.out.print("A: ");A = scan.nextInt();
                    System.out.print("B: ");B = scan.nextInt();
                    ...
                    System.out.println("Answer = "+answerAsInt);
                    break;
                case 4 : System.out.println("       Multiply Operator");
                    System.out.println("Enter Number for A and B:");
                    System.out.print("A: ");A = scan.nextInt();
                    System.out.print("B: ");B = scan.nextInt();
                    ...
                    System.out.println("Answer = "+answerAsInt);
                    break;
                case 5 : System.out.println("       Modulo Operator");
                    System.out.println("Enter Number for A and B:");
                    System.out.print("A: ");A = scan.nextInt();
                    System.out.print("B: ");B = scan.nextInt();
